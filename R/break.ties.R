...
#' break critical value ties. 
#' This internal l2boost helper function determines which direction is more favorable when two directions have the same value of rho.m
#' 
...
#'
break.ties <-
function(rho.m, corr.x, lr, lr.PlusOne, Lr, nu) {
